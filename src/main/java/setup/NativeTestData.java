...
public class NativeTestData {
    ...
    private static Object[] testDataProvider() throws IOException, ParseException {
    ...
    private static Object readJson(String filePath) throws IOException, ParseException {
